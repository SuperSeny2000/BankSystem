...
public class proba extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        open_fine_players_menu.dataManager = dataManager;
        list_richest_menu_class.dataManager = dataManager;
        updateMenuDisplay_class.dataManager = dataManager;
        ...
        Bukkit.getPluginManager().registerEvents(new PlayerChatMess(), this);
        Bukkit.getPluginManager().registerEvents(new open_fine_players_menu(), this);
        Bukkit.getPluginManager().registerEvents(new list_richest_menu_class(), this);
